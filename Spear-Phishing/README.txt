...
#When the information is entered in the hacker server's login form, the information is stored in the checkyet table of the hacker DB. When spear-phishing.sh is executed, the login data of the checkyet table is checked against the original server and the data is stored in the member table. That is, the data in the member table is 100% true.
